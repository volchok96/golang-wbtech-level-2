...
1. OrderProcessingFacade - основной фасад для работы с заказами.
2. InventoryService - сервис, который проверяет наличие товара на складе.
3. PaymentService - сервис для обработки платежей.
4. ShippingService - сервис для организации доставки.
5. NewOrderProcessingFacade - конструктор для создания фасада системы обработки заказов.
